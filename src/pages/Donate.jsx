    ...
    <section className="donate-content-section">  
        <div className="donate-content-container">  
            ...
            <div className="donate-block fade-in-up">  
                ...
                <h2 className="donate-subtitle">Support the White Cross.</h2>  
                <p className="donate-mission-text">
                    Your tax-deductible donation directly empowers the Epsilon Upsilon chapter. 
                    Contributions are strictly allocated to support <strong>house improvements, leadership scholarships, and the local ASU chapter fund</strong>.
                </p>
                <p className="donate-mission-text">
            ...
            <div className="donate-methods-grid fade-in-up">
                ...
                <div className="donate-method-card">
                    ...
                    <p>Make a secure, one-time or recurring gift via our online payment processor.</p>
                    <button className="circle-donate-btn" aria-label="Donate via Card">Secure Online Portal</button>
                </div>
                ...
                <div className="donate-method-card">
                    ...
                    <p>Send contributions instantly with zero processing fees. Scan the QR code or use our handles below.</p>
                    <div className="donate-digital-accounts">
                        <div className="digital-account">
                            <strong>Zelle:</strong> <span>treasurer@sigmachiasu.org</span>
                        </div>
                        <div className="digital-account">
                ...
                <div className="donate-method-card">
                    ...
                    <p>Please make checks payable to <strong>Sigma Chi Epsilon Upsilon</strong> and mail to our physical address:</p>
                    <div className="donate-address-block">
                        <strong>Sigma Chi Fraternity</strong><br/>
                        Epsilon Upsilon Chapter<br/>
